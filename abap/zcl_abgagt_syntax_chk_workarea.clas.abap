...
"! Checks ABAP source code syntax using the SYNTAX-CHECK statement approach.
"! This implementation wraps source with CLASS-POOL/INTERFACE-POOL and runs syntax check.
...
CLASS zcl_abgagt_syntax_chk_workarea IMPLEMENTATION.
  ...
  METHOD zif_abgagt_syntax_checker~check_class.
    " Run syntax check on the source wrapped with CLASS-POOL statement
  ...
  METHOD zif_abgagt_syntax_checker~check_interface.
    " Run syntax check on the source wrapped with INTERFACE-POOL statement
