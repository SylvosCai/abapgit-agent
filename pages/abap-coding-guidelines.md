...
| Guide | Description |
|-------|-------------|
| [Debug Session Guide](../abap/guidelines/debug-session) | Step-by-step debug workflow: set breakpoints, attach, inspect variables, pull flow architecture |
| [Dump Analysis Guide](../abap/guidelines/debug-dump) | Analyse ST22 short dumps using the `dump` command |
| [run Command Guide](../abap/guidelines/run-probe-classes) | Never-run-proactively rule, probe class workflow, scratchWorkspace setup |
